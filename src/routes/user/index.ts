...
get_methods.forEach(data => api_rutas[data.method](data.capacity, data.promise));
put_methods.forEach(data => api_rutas[data.method](data.capacity, data.promise));
delete_methods.forEach(data => api_rutas[data.method](data.capacity, data.promise));
post_methods.forEach(data => api_rutas[data.method](data.capacity, data.promise));

export const user_routes: ApiRuta = { name: 'user', api_rutas }
